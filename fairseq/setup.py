...
extensions.extend(
    [
        ...
        cpp_extension.CppExtension(
            ...
            sources=[
                "fairseq/clib/operators/alignment_train_cpu.cpp",
            ],
        ),
    ],
)
        ...
        [
            ...
            cpp_extension.CUDAExtension(
                ...
                sources=[
                    ...
                    "fairseq/clib/operators/alignment_train_cuda.cpp",
                ],
            ),
        ],
    )
...
if __name__ == "__main__":
    ...
    package_data = {"fairseq": get_files(os.path.join("fairseq", "config"))}
    print(package_data)
