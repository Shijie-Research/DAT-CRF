...
def add_preprocess_args(parser):
    ...
    group.add_argument(
        ...
        metavar="FP",
        default=None,
        help="comma separated, valid file prefixes (words missing from train set are replaced with <unk>)",
    )
    group.add_argument(
        "--testpref",
        metavar="FP",
        default=None,
        help="comma separated, test file prefixes (words missing from train set are replaced with <unk>)",
    )
