...
from fairseq.modules import FairseqDropout, LayerDropModuleList, MultiheadAttention
...
class TransformerSentenceEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.segment_embeddings = (
            nn.Embedding(self.num_segments, self.embedding_dim, padding_idx=None) if self.num_segments > 0 else None
        )
