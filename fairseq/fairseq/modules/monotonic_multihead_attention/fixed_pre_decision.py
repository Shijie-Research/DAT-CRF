        ...
        class FixedStrideMonotonicAttention(monotonic_attention):
            ...
            def add_args(parser):
                ...
                parser.add_argument(
                    ...
                    type=float,
                    default=0.3,
                    help="If a part of the sequence has pad" ",the threshold the pooled part is a pad.",
                )
            ...
            def p_choose(
                ...
                if p_choose.size(-1) < src_len:
                    ...
                    p_choose = torch.cat(
                        [p_choose, torch.zeros(p_choose.size(0), tgt_len, src_len - p_choose.size(-1)).to(p_choose)],
                        dim=2,
                    )
                else:
