...
class SentencepieceConfig(FairseqDataclass):
    ...
    sentencepiece_alpha: Optional[float] = field(
        default=None,
        metadata={"help": "smoothing parameter for unigram sampling, and merge probability for BPE-dropout"},
    )
...
class SentencepieceBPE(object):
    def __init__(self, cfg):
        ...
        sentencepiece_model = file_utils.cached_path(cfg.sentencepiece_model_path)
        try:
