...
def find_offsets(filename: str, num_chunks: int) -> tp.List[int]:
    """
    given a file and a number of chunks, find the offsets in the file
...
class ChunkLineIterator:
    """
    Iterator to properly iterate over lines of a file chunk.
    """
    ...
    def __iter__(self) -> tp.Iterable[str]:
        ...
        while line:
            ...
            # that the procedure breaks by the indeterministic behavior of
            # f.tell()
