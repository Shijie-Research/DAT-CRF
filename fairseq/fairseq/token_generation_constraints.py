...
* OrderedConstraintState: Tracks progress through an ordered list of multi-token constraints.
* UnorderedConstraintState: Tracks progress through an unordered list of multi-token constraints.
...
def pack_constraints(batch_constraints: List[List[torch.Tensor]]) -> torch.Tensor:
    """Takes a list of constraints in tensor form (a list of
