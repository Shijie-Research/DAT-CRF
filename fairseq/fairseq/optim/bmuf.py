...
class FairseqBMUF(FairseqOptimizer):
    ...
    block training with intra-block parallel optimization and block-wise
    ...
    def _update_global_model(self):
        for index, (param, global_param, smoothed_grad, grad) in enumerate(
            ...
            # global_param is basically last synchronized parameter. though
