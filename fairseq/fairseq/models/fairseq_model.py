...
class BaseFairseqModel(nn.Module):
    ...
    def prepare_for_inference_(self, cfg: DictConfig):
        ...
        kwargs["beamable_mm_beam_size"] = (
            None if getattr(cfg.generation, "no_beamable_mm", False) else getattr(cfg.generation, "beam", 5)
        )
...
class FairseqModel(FairseqEncoderDecoderModel):
    def __init__(self, *args, **kwargs):
        ...
        utils.deprecation_warning(
            "FairseqModel is deprecated, please use FairseqEncoderDecoderModel or BaseFairseqModel instead",
            stacklevel=4,
        )
...
class FairseqMultiModel(BaseFairseqModel):
    ...
    def __init__(self, encoders, decoders):
        ...
        self.models = nn.ModuleDict(
            {key: FairseqEncoderDecoderModel(encoders[key], decoders[key]) for key in self.keys},
        )
