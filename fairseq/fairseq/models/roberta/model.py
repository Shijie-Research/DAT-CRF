...
class RobertaModel(FairseqEncoderModel):
    ...
    def add_args(parser):
        ...
        # args for AdaPruning
        # In short, it adds regularization for the multihead attention module and feed forward neural nets
        ...
        parser.add_argument(
            ...
            metavar="D",
            default=0.0,
            help="scaling factor for regularization term in adaptive pruning, recommendation is 0.000375",
        )
        parser.add_argument(
...
def base_architecture(args):
    ...
    # R4F config
    args.spectral_norm_classification_head = safe_getattr(args, "spectral_norm_classification_head", False)
